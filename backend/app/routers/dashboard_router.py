...
from app.services.dashboard_service import get_monthly_dashboard_service, get_monthly_history_service, \
    ...
    get_top_expense_category_service, get_upcoming_obligations_service, get_overdue_obligations_service
...
@router.get(
    "/overdue-obligations",
    response_model=OverdueObligationsResponse,
...
def get_overdue_obligations(
    ...
    return get_overdue_obligations_service(
        current_user,
        db
    )